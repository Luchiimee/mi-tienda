...
export default function ConfiguracionPage() {
  const { shopData, updateProfile, changePassword, updateTemplateSlug, resetTemplate, lockTemplate, activateTrial } = useShop();
  ...
  // --- NUEVO ESTADO PARA EL BOTÓN DE PRUEBA ---
  ...
  // Estado para seleccionar plantilla en el plan simple (si es nuevo usuario)
  ...
  useEffect(() => {
      ...
      else setSelectedPlan('full'); // Por defecto Full
  }, [shopData.plan]);
            ...
            <div style={{ background: 'white', padding: 30, borderRadius: 16, boxShadow: '0 4px 20px rgba(0,0,0,0.03)', border: shopData.plan === 'none' ? '2px solid #f1c40f' : '1px solid #f1f5f9', display:'flex', flexDirection:'column' }}>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 15, marginBottom: 20 }}>
                    ...
                    >
                        ...
                        {/* SELECTOR DE PLANTILLA (SOLO SI ES NUEVO Y ELIGE SIMPLE) */}
                ...
                {/* SELECTOR DE PLANTILLA (SOLO SI ES SIMPLE Y YA ESTÁ BLOQUEADO) */}
