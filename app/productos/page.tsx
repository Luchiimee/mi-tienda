...
import UpgradeModal from '../components/UpgradeModal'; // 👈 IMPORTAMOS EL MODAL

export default function ProductosPage() {
  const { shopData, addProduct, updateProduct, deleteProduct, canEdit } = useShop(); // 👈 TRAEMOS canEdit
  ...
  const handleOpenEditor = (product?: Product) => {
      if (!checkPermissions()) return; // 🔒 BLOQUEO AQUÍ
  ...
  const handleChange = (e: any) => {
      // 🔒 No hace falta bloquear aquí si el modal ya bloquea la apertura, 
      // pero por seguridad extra lo dejamos si quieres
